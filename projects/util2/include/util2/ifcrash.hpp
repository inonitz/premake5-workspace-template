...
{ \
	util2::detail::ifcrash_macro::__common_print_fmt(detail::ifcrash_macro::str_msg_begin, name, __FILE__, __LINE__, name); \
	if constexpr (str_or_fmt_required) { \
		util2::detail::ifcrash_macro::__common_print_fmt(detail::ifcrash_macro::str_msg_mid, name); \
		util2::detail::ifcrash_macro::__common_print##append_name_if_required(str, ##__VA_ARGS__); \
	} \
    { action; } \
	util2::detail::ifcrash_macro::__common_print_fmt(detail::ifcrash_macro::str_msg_end, name); \
