...
Current Integration of tools:
  ...
  - Various useful C++ Libraries
    ...
    * [GoogleMock & GoogleTest](https://github.com/google/googletest) **<-- This is the branch you're on**
...
[<img height="150px" src="https://avatars.githubusercontent.com/u/1342004?s=1508&v=4">][GoogleTest-Mock-url] </br>
...
```sh
git clone -b GoogleTest-Mock https://github.com/inonitz/premake5-workspace-template.git
...
- Generating Test Unit-Projects for each library (see working example for GoogleTest-Samples  [```sample/premake5.lua```](https://github.com/inonitz/premake5-workspace-template/blob/GoogleTest-Mock/projects/sample/premake5.lua) )
...
[GoogleTest-Mock-url]: https://github.com/google/googletest
